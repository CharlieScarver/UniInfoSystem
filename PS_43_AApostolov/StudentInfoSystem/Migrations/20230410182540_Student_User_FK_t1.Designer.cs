...
namespace StudentInfoSystem.Migrations
{
    ...
    [Migration("20230410182540_Student_User_FK_t1")]
    partial class Student_User_FK_t1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentInfoSystem.Student", b =>
                {
                    ...
                    b.HasIndex("UserFacNum")
                        .IsUnique()
                        .HasFilter("[UserFacNum] IS NOT NULL");
            ...
            modelBuilder.Entity("StudentInfoSystem.Student", b =>
                {
                    b.HasOne("Lab01_UserLogin.User", null)
                        .WithOne()
                        .HasForeignKey("StudentInfoSystem.Student", "UserFacNum")
